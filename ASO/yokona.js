...
const crying = document.getElementById('sadwinter');
const sadboi = document.getElementById('sadirene');
const sadman  = document.getElementById('sadman');
const hahahuhu = document.getElementById('hahahuhu');
const hang = document.getElementById('sadkarina');
const sadsad = document.getElementById('sadseul');
